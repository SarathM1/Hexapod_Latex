...
Li=T(f2(2)+1:f2(3)-1)
Hu=T(f2(3)+1:f2(4)-1)
uicontrol('style','text','position',[25,100,80,30],'backgroundcolor',[0,0,0],'foregroundcolor',
[0,1,1],'fontsize',10.0,'string','Temperature')
uicontrol('style','edit','position',[25,70,60,30],'backgroundcolor',[0,0,0],'foregroundcolor',
[0,1,1],'fontsize',10.0,'string',Tm)
uicontrol('style','text','position',[110,100,60,30],'backgroundcolor',[0,0,0],'foregroundcolor',
[0,1,1],'fontsize',10.0,'string','Light')
uicontrol('style','edit','position',[120,70,60,30],'backgroundcolor',[0,0,0],'foregroundcolor',
[0,1,1],'fontsize',10.0,'string',Li)
uicontrol('style','text','position',[25,30,60,30],'backgroundcolor',[0,0,0],'foregroundcolor',
[0,1,1],'fontsize',10.0,'string','Humidity')
uicontrol('style','edit','position',[25,10,60,30],'backgroundcolor',[0,0,0],'foregroundcolor',
[0,1,1],'fontsize',10.0,'string','60')
end
pause(1)
end
% --- Executes on button press in cmmprtt.
functioncmmprtt_Callback(hObject, eventdata, handles)
...
functionimgdttt_Callback(hObject, eventdata, handles)
...
functionstppsnsrr_Callback(hObject, eventdata, handles)
